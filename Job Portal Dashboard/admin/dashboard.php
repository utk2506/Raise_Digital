...
<html lang="en">
  <head>
    ...
    <title>JobSpotHub | Dashboard</title>
                  ...
                  while($row = $result->fetch_assoc()) {
                    ?>
                      <tr>
                        ...
                        <td style="padding: 0px 50px 0px 50px;"><a href="reject-company.php?id=<?php echo $row['id_company']; ?>">Reject</a> <a href="approve-company.php?id=<?php echo $row['id_company']; ?>">Approve</a></td>
                      </tr>
                    <?php
                  }
                }
